                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="card-text pb-3">
                                shippingFee{{getCurrencyFormat(productDetail.delivery_price)}}won | 도서산간(제주도) 베송비 추가 {{getCurrencyFormat(productDetail.add_delivery_price)}}원 | 택배배송 | {{productDetail.outbound_days}}일 이내 출고 (주말,공휴일 제외)
                            </p>
